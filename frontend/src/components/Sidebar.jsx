...
const Sidebar = ({ setSelectedGroup }) => {
  ...
  const fetchGroups = async () => {
    try {
      ...
      const { data } = await axios.get('https://mern-chat-app-eygf.onrender.com/api/groups', {
        headers: {
  ...
  const handleCreateGroup = async () => {
    try {
      ...
      const token = userInfo.token;
      await axios.post(
        'https://mern-chat-app-eygf.onrender.com/api/groups',
        {
          name: newGroupName,
  ...
  const handleJoinGroup = async (groupId) => {
    try {
      ...
      const token = userInfo.token;
      await axios.post(
        `https://mern-chat-app-eygf.onrender.com/api/groups/${groupId}/join`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleLeaveGroup = async (groupId) => {
    try {
      ...
      const token = userInfo.token;
      await axios.post(
        `https://mern-chat-app-eygf.onrender.com/api/groups/${groupId}/leave`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
